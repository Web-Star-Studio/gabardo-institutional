...
const SejaAgregadoHeroSection = () => {
  return (
    <section className="relative w-full h-screen text-white overflow-hidden">
      <div className="absolute inset-0">
        <Image
          src={heroImage}
          alt="Parceiro agregado da Gabardo em operação"
          fill
          priority
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center px-4 sm:px-6 md:px-8 lg:px-16">
        ...
        >
          Parceiros que movimentam o Brasil
        </motion.span>
        ...
        >
          Conecte-se a uma operação logística que valoriza parceria, transparência e cuidado com cada viagem. Juntos, garantimos entregas seguras e uma jornada eficiente para nossos clientes.
        </motion.p>
        ...
        >
          <span className="text-xs tracking-[0.3em] uppercase text-white/70">Role para conhecer as condições</span>
...
export default SejaAgregadoHeroSection;

      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              É um tema urgente para todo o mundo e temos uma responsabilidade como parte da cadeia de logística que, de ponta a ponta, contribui para a queima de combustível, emissões de gases de efeito estufa e poluentes.
            </motion.p>
          </div>
          <motion.div
          ...
          >
            <Image
              src="/images/gabardo-hero-02.JPG"
